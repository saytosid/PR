function [tc1,tc2,tc3,tp1,tp2,tp3] = classifier3(X,Y,Z,W)
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('Classifier3 OD Bayes C1,C2');
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('Classifier3 OD Bayes C2,C3');
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('Classifier3 OD Bayes C1,C3');
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('Classifier3 OD Bayes C4,C1');
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('Classifier3 OD Bayes C2,C4');
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('Classifier3 OD Bayes C4,C3');
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('Classifier3 OD Bayes Contour plot');
   legend([p1,p2,p3,p4],'Class1','Class2','Class3','Class4');   
   print -djpg 35.jpg;
end;   
