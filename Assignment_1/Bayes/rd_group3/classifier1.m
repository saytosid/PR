function [tc1,tc2,tc3,tp1,tp2,tp3] = classifier1(X,Y,Z)
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('classifier1 RD Bayes C1,C2');
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('classifier1 RD Bayes C2,C3');
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('classifier1 RD Bayes C1,C3');
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('classifier1 RD Bayes Contour plot');
   legend([p1,p2,p3],'Class1','Class2','Class3');   
   print -djpg 15.jpg;
end;   
