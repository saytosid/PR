function [tc1,tc2,tc3,tp1,tp2,tp3] = classifier1(X,Y)
   ...
   % xlabel('x coordinate');
   % ylabel('y coordinate');
   % title('Classifier1 InterLock Bayes');
   ...
   % xlabel('x coordinate');
   % ylabel('y coordinate');
   % title('Classifier1 InterLock Bayes C1,C2');
   % legend([p1,p2],'Class1','Class2');
   % print -djpg 12.jpg;
   % hold off;
   ...
   hold on;
   [x,y]=meshgrid(-2:0.1:3,-1.5:0.1:1.5);
   i_max = size(x)(1,1);
   j_max = size(y)(1,2);
   for i = 1:1:i_max,
    for j = 1:1:j_max,
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('Classifier1 InterLock Bayes Contour plot');
   legend([p1,p2],'Class1','Class2');   
   print -djpg 15.jpg;
end;   
