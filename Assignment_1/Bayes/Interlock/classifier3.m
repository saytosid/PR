function [tc1,tc2,tc3,tp1,tp2,tp3] = classifier3(X,Y)
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('Classifier3 InterLock Bayes');
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('Classifier3 InterLock Bayes C1,C2');
   legend([p1,p2],'Class1','Class2');
   print -djpg 32.jpg;
   hold off;
   ...
   xlabel('x coordinate');
   ylabel('y coordinate');
   title('Classifier3 InterLock Bayes Contour plot');
   legend([p1,p2],'Class1','Class2');
   print -djpg 35.jpg;
end;   
